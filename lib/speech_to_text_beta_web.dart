library flutter_google_speech_beta_web;
...
/// THIS IS FOR WEB TESTING ONLY
/// An interface to Google's Speech-to-Text Api via grpc-web.
///
/// Important! You need an own Google project to use this class.
class SpeechToTextBetaWeb {
  ...
  final GrpcWebClientChannel _channel = GrpcWebClientChannel.xhr(
      Uri.parse('speech.googleapis.com'));

  // Private constructor to prevent direct initialization of the class.
  SpeechToTextBetaWeb._(this._options);

  /// Creates a SpeechToText interface using a service account.
  factory SpeechToTextBetaWeb.viaServiceAccount(ServiceAccount account) =>
      SpeechToTextBetaWeb._(account.callOptions);
